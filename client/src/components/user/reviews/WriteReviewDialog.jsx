...
const WriteReviewDialog = ({
  ...
  className="w-full max-w-2xl rounded-3xl border border-secondary/20 bg-secondary p-6 text-text-base shadow-2xl shadow-secondary/20"
>
  <div className="flex flex-col gap-2 sm:flex-row sm:items-start sm:justify-between">
    ...
    <button
      type="button"
      onClick={() => onClose?.()}
      className="self-start rounded-full border border-secondary/20 px-3 py-1 text-xs font-semibold uppercase tracking-[0.3em] text-text-base transition hover:border-primary"
    >
      Close
    </button>
  </div>
  ...
  <div className="mt-6 space-y-6">
            ...
            <button
              ...
              className={`flex h-10 w-10 items-center justify-center rounded-full border transition ${
                active
                  ...
                  : "border-secondary/20 bg-background text-text-muted"
              }`}
    ...
    <label className="block text-sm">
      <span className="mb-2 block text-text-base/80">Review title</span>
      <input
        type="text"
        name="title"
        ...
        className="w-full rounded-2xl border border-secondary/20 bg-background px-4 py-3 text-sm text-text-base outline-none transition focus:border-primary/70"
      />
    </label>

    <label className="block text-sm">
      <span className="mb-2 block text-text-base/80">Tell us more</span>
      <textarea
        name="comment"
    ...
    <div className="grid gap-4 sm:grid-cols-2">
      <label className="block text-sm">
        <span className="mb-2 block text-text-base/80">Size</span>
        <input
          type="text"
          name="variantSize"
      ...
      <label className="block text-sm">
        <span className="mb-2 block text-text-base/80">Colour</span>
        <input
          type="text"
          name="variantColor"
    ...
    <p className="rounded-2xl border border-primary/30 bg-primary/10 px-4 py-3 text-xs text-text-base/80">
  ...
  <div className="mt-6 flex flex-wrap items-center justify-between gap-3">
    ...
    <button
      type="submit"
      disabled={saving}
      className="inline-flex min-w-[10rem] items-center justify-center rounded-full border border-primary/70 px-5 py-2.5 text-xs font-semibold uppercase tracking-[0.3em] text-text-base transition hover:border-primary disabled:cursor-not-allowed disabled:opacity-60"
    >
